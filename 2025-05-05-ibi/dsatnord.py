...
parts = [
    (2, "red", 16, "header", "4"),
    (3, "blue", 20 * 4 + 169 * 4 + 2280 + 30*4 + 844 + 2990*4 + 41245 * 4 + 135064, "offsets", "5"),
    (5, "#267d40", 754077, "tiles0", "7"),
    (6, "#31a354", 9056940, "tiles1", "7/3"),
    (10, "#3182bd", 567760, "paths", "9"),
    (11, "#fd8d3c", 975894 + 994802, "topware", "10"),
    (1, "#974ea3", 13394 * 64, "places", "2/3"),
    (12, "#666666", 24 * 16, "unknown", "11/0/0"),
    (9, "#e6550d", 4878 * 201, "citysigns", "8"),
    (4, "#6baed6", 1691200, "paths", "6"),
    (7, "#73c475", 70627806, "tiles2", "7/5"),
    (8, "#a1d99b", 644804703 + 936 - 86822577, "tiles3", "7/6"),
    (12, "#666666", 644824916 - 644804703 - 936, "unknown", "11/0/1"),
    (12, "#666666", 8995, "unknown", "11/0/2")
]
